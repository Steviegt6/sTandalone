...
namespace Terraria.ModLoader.Setup
{
	public partial class MainForm : Form, ITaskInterface
	{
		...
		public MainForm()
		{
			...
			taskButtons[buttonDiffStandalone] = () => new DiffTask(this, "src/Terraria", "src/tStandalone", "patches/tStandalone", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
			taskButtons[buttonPatchStandalone] = () => new PatchTask(this, "src/Terraria", "src/tStandalone", "patches/tStandalone", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
			taskButtons[buttonSetupDebugging] = () => new SetupDebugTask(this);

			taskButtons[buttonRegenSource] = () =>
				new RegenSourceTask(this, new[] { buttonPatchTerraria, buttonPatchModLoader, buttonPatchStandalone, buttonSetupDebugging }
